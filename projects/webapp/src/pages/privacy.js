    ...
    <Frame className="my-12 sm:my-20 hyphens-auto">
      <div className="max-w-2xl mx-auto">
        <div className="mb-10">
          ...
          <Text style="textSm" className="mb-3">
            {privacyData[0].description[0]}
          </Text>
          <Text style="textSm">{privacyData[0].description[1]}</Text>
        </div>
        <div className="mb-10">
          <Text as="h2" style="titleSmSemi" className="mb-3">
            {privacyData[1].title}
          </Text>
          <Text style="textSm">{privacyData[1].description[0]}</Text>
        </div>
        <div className="mb-10">
          <Text as="h2" style="titleSmSemi" className="mb-3">
            {privacyData[2].title}
        ...
        <div className="mb-10">
          <Text as="h3" style="titleSmSemi" className="mb-3">
            {privacyData[3].title}
          </Text>
          <Text style="textSm">{privacyData[3].description[0]}</Text>
        </div>
        <div className="mb-10">
          <Text as="h3" style="titleSmSemi" className="mb-3">
            {privacyData[4].title}
          </Text>
          <Text style="textSm">{privacyData[4].description[0]}</Text>
        </div>
        <div className="mb-10">
          <Text as="h3" style="titleSmSemi" className="mb-3">
            {privacyData[5].title}
          ...
          <Text style="textSm">{privacyData[5].description[2]}</Text>
        </div>
        <div className="mb-10">
          <Text as="h3" style="titleSmSemi" className="mb-3">
            {privacyData[6].title}
          </Text>
          <Text style="textSm">{privacyData[6].description[0]}</Text>
        </div>
        <div className="mb-10">
          <Text as="h3" style="titleSmSemi" className="mb-3">
            {privacyData[7].title}
